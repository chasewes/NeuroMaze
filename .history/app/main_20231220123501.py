...
def scale_image(maze_image, scale_factor=1):
...
st.image(maze_image, caption='Initial Maze', use_column_width=False)


st.image(scale_image(maze_image), caption='Initial Maze resized', use_column_width=False)
