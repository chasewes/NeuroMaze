...
load_checkpoint('checkpoints//Users/chasewesthoff/Desktop/NeuroMaze/app/checkpoints/checkpoint_lr_0.0001_bs_1_epoch_5.pth.tar.pth', model)  # Load your saved model
model.eval()
