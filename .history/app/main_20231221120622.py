...
st.markdown("<h3 style='text-align: center;'>Dive into a unique maze where each move and new frame is dynamically generated by a sophisticated neural network, predicting your next challenge in real-time.</h3>", unsafe_allow_html=True)
