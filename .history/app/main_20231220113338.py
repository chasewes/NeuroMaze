...
from utils import generate_maze, preprocess_image, postprocess_imagefrom utils import load_checkpoint
...
load_checkpoint('checkpoints/checkpoint_lr_0.0001_bs_1_epoch_5.pth.tar.pth', model)  # Load your saved model
model.eval()
