...
st.markdown("""
    <h1 style='text-align: center;'>NeuroMaze 
        <span style="font-size:16px;position:relative;top:-5px;">
            <sup>
                <i class="fas fa-info-circle" title="Dive into a unique maze experience where each move and new frame is dynamically generated by a sophisticated neural network, predicting your next challenge in real-time."></i>
            </sup>
        </span>
