...
with col2:
    st.write("")  # Empty column for spacing
    left_action = st.button("⬅️", key="left_button", help="Move left")
...
with col2:
    up_action = st.button("⬆️", key="up_button", help="Move up")
    down_action = st.button("⬇️", key="down_button", help="Move down")
...
with col2:
    st.write("")  # Empty column for spacing
    right_action = st.button("➡️", key="right_button", help="Move right")
