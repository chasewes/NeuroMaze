...
st.markdown("<h3 style='text-align: center;'>Dive into a unique maze where each new frame is generated by a neural network, predicting your next state in real-time. If it breaks, generate a new maze and try again!</h3>", unsafe_allow_html=True)
