...
st.markdown('<div style="display: flex; justify-content: center;"><img src="data:image/png;base64,{}" alt="Maze State"></div>'.format(scale_image(st.session_state.current_maze_image)), unsafe_allow_html=True)
